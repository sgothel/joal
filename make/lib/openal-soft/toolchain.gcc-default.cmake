...
if(NOT APPLE)
    set(CMAKE_C_FLAGS "-include ${PROJECT_SOURCE_DIR}/../make/lib/openal-soft/glibc-compat-symbols.h")
    set(CMAKE_CXX_FLAGS "-include ${PROJECT_SOURCE_DIR}/../make/lib/openal-soft/glibc-compat-symbols.h")
endif()
