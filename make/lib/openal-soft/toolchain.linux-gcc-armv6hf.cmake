...
if(NOT APPLE)
    ...
    set(CMAKE_C_FLAGS "-march=armv6 -mfpu=vfp -mfloat-abi=hard -marm -include ${GLUEGEN_ROOT}/make/stub_includes/platform/glibc-compat-symbols.h")
    set(CMAKE_CXX_FLAGS "-march=armv6 -mfpu=vfp -mfloat-abi=hard -marm -include ${GLUEGEN_ROOT}/make/stub_includes/platform/glibc-compat-symbols.h")
endif()
