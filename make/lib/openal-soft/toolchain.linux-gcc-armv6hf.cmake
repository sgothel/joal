...
if(NOT APPLE)
    ...
    set(CMAKE_C_FLAGS "-march=armv6 -mfpu=vfp -mfloat-abi=hard -marm -include ${PROJECT_SOURCE_DIR}/../make/lib/openal-soft/glibc-compat-symbols.h")
    set(CMAKE_CXX_FLAGS "-march=armv6 -mfpu=vfp -mfloat-abi=hard -marm -include ${PROJECT_SOURCE_DIR}/../make/lib/openal-soft/glibc-compat-symbols.h")
endif()
